...
sys.path.append('/home/mihnea/mihnea/GGS/models')
...
if __name__ == '__main__':
    ...
    weights_path = '/media/mihnea/0C722848722838BA/ScanNet++2/experiments/point_contrast_scannetpp/model_weights/best_model_epoch_5_loss_0.0239.pth'
