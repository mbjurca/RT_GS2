...
class GaussianRasterizer(nn.Module):
    ...
    def forward(self, means3D, means2D, opacities, shs = None, sh_objs = None, colors_precomp = None, scales = None, rotations = None, cov3D_precomp = None, mask=None):
        ...
        if sh_objs is None:
            sh_objs = torch.zeros((means3D.shape[0], 16, 1), device='cuda')
