...
def extract_contrastive_data(train_scene_list, test_scene_list, root_dir):
    ...
    for stage in ['train', 'test']:
        ...
        list_models = train_scene_list if stage == 'train' else test_scene_list
        path = output_path_train if stage == 'train' else output_path_test

        for scene_idx, scene_name in enumerate(list_models):
            ...
            for idx_view_1 in range(0, len(views) - 1, 25): # -1 ensures the last view is not compared with itself (as it would have no subsequent views)
...
if __name__ == '__main__':
    ...
    train_scene_list = ['8b2c0938d6', '076c822ecc', '07f5b601ee', '08bbbdcc3d', '09bced689e', '1ae9e5d2a6', '210f741378', '260db9cf5a', '2b1dc6d6a5', '302a7f6b67',
    ...
    test_scene_list = ['1366d5ae89', '1a130d092a', '1a8e0d78c0', '281bc17764', '28a9ee4557', '2a496183e1', '39f36da05b', '4ba22fa7e4', '6d89a7320d', 'acd69a1746']

    root_dir = '/media/mihnea/0C722848722838BA/ScanNet++2/final_split'
    extract_contrastive_data(train_scene_list=train_scene_list,
                        test_scene_list=test_scene_list,
                        root_dir=root_dir)
