...
def extract_contrastive_data(list_models, path='/media/mihnea/0C722848722838BA/Replica2/contrastive_data_test'):

    os.makedirs(path, exist_ok=True)

    for scene_idx, scene_dir in enumerate(list_models):
...
def voxelize_point_clouds(xyz, mask_1, mask_2, voxel_size=0.07):
...
if __name__ == '__main__':
    ...
    list_models = ['/media/mihnea/0C722848722838BA/Replica2/office_0',
    ...
    extract_contrastive_data(list_models=list_models)
