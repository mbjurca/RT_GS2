...
class Replica_PointContrast(data.Dataset):
    ...
    def __init__(self, 
        ...
        for scene in scene_list:
            model_path = os.path.join(scene, 'point_cloud', 'iteration_30000', 'point_cloud.ply')
    ...
    def __getitem__(self, index): 
        ...
        first_digit = int(re.search(r'\d', self.pairs_list[index]).group())
        xyz, features_dc, features_extra, scales, rots, opacities = self.load_ply(self.model_list[first_digit])
...
if __name__ == "__main__":
    ...
    test_dataset = Replica_PointContrast(scene_list=scene_list, 
                            pair_dir='/media/mihnea/0C722848722838BA/Replica2/contrastive_data_train',
                            device='cuda:0')
